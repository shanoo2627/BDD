...
public class WebDriverUtility {
	 ...
	 * @param driver
	 */
	public void waitForPageLoad(long longTimeout) 
	{
	 ...
	 * @param element
	 */
	public void waitForElementToBeClickable(long timeOuts, WebElement element)
	{
	 ...
	 * @param element
	 */
	public void waitForElementToBeVisible(long timeOuts,WebElement element)
	{
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOuts));
